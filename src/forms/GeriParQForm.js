  ...
  const newForm = () => (
    ...
    >
      <Fragment>
        ...
        <h3>
          {' '}
          PHYSICAL ACTIVITY READINESS QUESTIONNAIRE (PAR-Q) <br />* If you have answered ‘Yes’ to
          one or more questions above, you should talk with your doctor BEFORE you start becoming
        ...
        pressure or heart condition? <br />
        (If yes, refer to PT consult)
