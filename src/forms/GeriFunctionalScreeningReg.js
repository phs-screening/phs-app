  ...
  const newForm = () => (
    ...
    >
      <Fragment>
        ...
        <RadioField
          name='geriFunctionalScreeningRegFormQ1'
          label='geriFunctionalScreeningRegForm - Q1'
        />
        <br />
        Which functional screening does the participant prefer?
        <RadioField
          name='geriFunctionalScreeningRegFormQ2'
          label='geriFunctionalScreeningRegForm - Q2'
        />
        <br />
        If participant prefers HPB screening, which event will they be going to? (event; date):
        <LongTextField
          name='geriFunctionalScreeningRegFormQ3'
          label='geriFunctionalScreeningRegForm - Q3'
        />
        <br />
        Helped participant sign up on HPB FormSG?
        <RadioField
          name='geriFunctionalScreeningRegFormQ4'
          label='geriFunctionalScreeningRegForm - Q4'
        />
        <br />
        Additional notes:
        <LongTextField
          name='geriFunctionalScreeningRegFormQ5'
          label='geriFunctionalScreeningRegForm - Q5'
        />
      </Fragment>
      <ErrorsField />
