...
const schema = new SimpleSchema({
  ...
  'feedbackFormQ2.$': {
    type: String,
    allowedValues: [
      'I am concerned about my health 我关心自己的健康',
      'I have never been screened before 我从未经过身体检查',
      'Friends/family told me to come 朋友/家人劝我应该参与',
      'There is a free health screening 这项身体检验是免费的',
      'There is a free goodie bag 活动有赠送礼包',
      'I was drawn by the exhibition booths 我被健康展览所吸引',
      'I was drawn by the carnival 我被嘉年华会所吸引',
      'I was drawn to the crowd 我被人群所吸引',
      'It is conveniently located 活动地点对我很方便',
      'It is at a convenient timing 活动时间对我很方便',
      'Others (please specify) 其他原因：(请注明)',
    ],
  },
  feedbackFormQ3: {
    type: String,
  ...
  feedbackFormQ5: {
    ...
    allowedValues: [
      'NIL',
      'Only once (Today) 一次而已 （今天）',
      'Two Times 两次',
      'Thrice 三次',
      'Four Times 四次',
      'Five Times (五次）',
      'Six Times (六次）',
      'Seven or more times (七次以上）',
    ],
    optional: false,
  },
  feedbackFormQ6: {
  ...
  feedbackFormQ7: {
    ...
    allowedValues: [
      'Not Applicable',
      'In the past month 这个月',
      'In the past year 今年内',
      '2-3 years ago 两到三年前',
      '>4 years ago 多过四年前',
    ],
    optional: false,
  ...
  feedbackFormQ9: {
    type: String,
    allowedValues: [
      'No I am unaware of other screenings 没有',
      'Community Centre (CC) 民众俱乐部（CC）',
      'Polyclinic 综合诊疗所',
      'GP clinic 私人诊所',
      'Others (Pls specify) 其他（请注明）_____________',
    ],
    optional: false,
  },
  feedbackFormQ10: {
  ...
  'feedbackFormQ15.$': {
    type: String,
    allowedValues: ['Expensive  太贵', 'Too Far 太远', 'Too time consuming 太费时间'],
  },
  feedbackFormQ16: {
    type: String,
    allowedValues: [
  ...
  'feedbackFormQ27.$': {
    type: String,
    allowedValues: [
      'Happened to pass by 刚好经过',
      'Posters, banners 海报/旗帜',
      'PHS Facebook Page 公共健康服务官方脸书',
      'Community Centre (CC) 社区中心（CC）',
      'SMS Reminder (简讯）',
      'PHS Instagram 公共健康服务 Instagram',
      'Door-to-Door Publicity 义工上门宣传',
      'Lamp post banners 路灯上的海报',
      'PHS Website (www.publichealthservice.org) 公共健康服务官方网站',
      'Newspaper 报纸',
  ...
  feedbackFormQ29: {
    type: String,
    allowedValues: ['Yes', 'No', 'Did not receive brochure'],
    optional: true,
  },
  feedbackFormQ30: {
    type: String,
  ...
  render() {
    ...
    const newForm = () => (
      ...
      >
        <Fragment>
          <h2>
            PHS 2021 Screening Feedback Form
            <br />
            公共健康服务 2021 检验反馈表
          </h2>
          <h3>
            We would like to know how you felt about our health screening, as well as how you came
            to know about it :) Your feedback will go a long way in helping us improve our event!
            <br /> 我们想寻求您对我们公共健康服务 2019
            的感受，并且告诉我们您在什么情况下得知这活动的详情!{' '}
          </h3>
          1. I have had a good experience at the PHS 2019 screening.
          <br /> 我在公共健康服务 2019 中有良好的体验。
          <RadioField name='feedbackFormQ1' label='Feedback Form Q1' />
          <h3>
            2. We would like to find out some of the reasons why you came for the PHS 2019
          ...
          <h3>
            9. We would like to find out more about how you felt about our student volunteers.
            <br /> 您对我们学生义工们的表现有所看法？
          </h3>
          ...
          <h3>
            11. Do let us know how you felt about the operational aspects of the screening.
            <br />
            您对此健康检查的执行方式有任何评语？
          </h3>
