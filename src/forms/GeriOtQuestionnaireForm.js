...
const schema = new SimpleSchema({
  geriOtQuestionnaireQ1: {
    ...
    type: String, allowedValues: ["Yes", "No", "NA (client uses wheelchair constantly)"], optional: false
  }, geriOtQuestionnaireQ7: {
    type: String, allowedValues: ["Yes", "No"], optional: false
  },geriOtQuestionnaireQ8: {
    type: String, allowedValues: ["Yes", "No"], optional: false
  }, geriOtQuestionnaireQ9: {
    type: String, allowedValues: ["Yes", "No", "NA (nil kerbs and steps - new BTO building)"], optional: false
  }, geriOtQuestionnaireQ10: {
    type: String, optional: true
  }, geriOtQuestionnaireQ11: {
    type: String, allowedValues: ["Yes", "No", "NA (client uses commode constantly)"], optional: false
  }, geriOtQuestionnaireQ12: {
    type: String, allowedValues: ["Yes", "No", "NA (does not use bathtub, uses shower)"], optional: false
  }, geriOtQuestionnaireQ13: {
    type: String, allowedValues: ["Yes", "No", "NA (nil shower at home, uses bathtub)"], optional: false
    ...
    type: String, allowedValues: ["Yes", "No", "NA (no steps / stairs at home - including toilet - new BTO building)"], optional: false
  }, geriOtQuestionnaireQ21: {
    type: String, allowedValues: ["Yes", "No", "NA (nil steps / kerbs at entrance)"], optional: false
  },geriOtQuestionnaireQ22: {
    type: String, allowedValues: ["Yes", "No", "NA (nil steps at home, lift landing, does not climb stairs)"], optional: false
  }, geriOtQuestionnaireQ23: {
    type: String, allowedValues: ["Yes", "No", "NA (nil steps at home, lift landing, does not climb stairs)"], optional: false
  }, geriOtQuestionnaireQ24: {
    type: String, allowedValues: ["Yes", "No"], optional: false
  }, geriOtQuestionnaireQ25: {
    type: String, allowedValues: ["Yes", "No", "NA (nil garden, path, corridor walkway)"], optional: false
    ...
    const newForm = () => (
      ...
      >
        <Fragment>
          ...
          <b style={{color : "red"}}>Instructions: Please select either YES / NO / NA. Remember to fill up the total scoring</b>
          <br/>
          The HOMEFAST assessment is a 25 question standardized assessment that aims to identify any potential fall risks at home, and within your home environment (lift landing, corridor). The Occupational Therapist will then advise you on some possible home modifications to make to
          minimize these risks, should there be a concern.
          <br/><br/>
          <h3>HOME ENVIRONMENT (LIVING ROOM / HOME ENTRANCE)</h3>
          <br/>
          1. Are your walkways free of cords and other clutter?<br/>
          <p><b>Definition:</b> No cords / clutter that obstruct door opening / closing or in the walkway.
            No items behind / in front of doors that prevent them from opening fully</p>
          <RadioField name="geriOtQuestionnaireQ1" label="geriOtQuestionnaire-Q1" />
          <br/>
          2. Are your floor coverings in good condition?<br/>
          <p><b>Definition:</b> Carpets / mats are flat on the ground. No cracked / missing tiles including
            stair coverings</p>
          ...
          <p><b>Definition:</b> Score ‘NO” if kitchen, toilet are non-slip, Score “YES” if kitchen, toilet are non-slip</p>
          <RadioField name="geriOtQuestionnaireQ3" label="geriOtQuestionnaire-Q3" />
          <br/>
          4. Are your loose mats securely fixed to the floor?
          <p><b>Definition:</b> If backings of mats are safely taped/nailed to the ground</p>
          <RadioField name="geriOtQuestionnaireQ4" label="geriOtQuestionnaire-Q4" />
          <br/>
          5. Can you get in and out of bed easily and safely?
          <p> <b>Definition:</b> Bed is of adequate height and firmness, without the need to pull self up
           with the aid of bedside furniture.</p>
          <RadioField name="geriOtQuestionnaireQ5" label="geriOtQuestionnaire-Q5" />
          <br/>
          6. Can you get up from your chair/sofa easily?
          <p><b>Definition:</b> Chair / sofa is of adequate height, arm rests are accessible to push from,
            and seat cushion not too soft or deep</p>
          ...
          <p><b>Definition:</b> No shadows thrown across the room. No excessive glare</p>
          <RadioField name="geriOtQuestionnaireQ7" label="geriOtQuestionnaire-Q7" />
          <br/>
          8. Can you switch a light on easily from your bed?
          <p><b>Definition: </b> Client does not need to get out of bed to switch on a light. Has flashlight
            or bedside lamp </p>
          ...
          <p><b>Definition:</b> Light exists at the back and front of doors. Lift lobbies and corridors have
            sufficient lighting to ambulate</p>
          ...
          <p><b>Definition:</b> Toilet seat is of adequate height, does not need to hold onto sink / towel
            rail / toilet paper holder to stand. Grab bars are present when needed</p>
          ...
          <p><b>Definition:</b> Client is able to step over bathtub and lower themselves without grabbing
            onto furniture</p>
          ...
          <p><b>Definition:</b> Client can step over kerbs / recesses without the need to hold onto
            anything </p>
          ...
          <p><b>Definition:</b> Grab bars EXCLUDING towel rails, sink, toilet paper holder.</p>
          <RadioField name="geriOtQuestionnaireQ14" label="geriOtQuestionnaire-Q14" />
          <br/>
          14. Are there any non-slip mats in the shower area?
          <p><b>Definition:</b> Well maintained slip resistant rubber mats / non slip strips / non slip floor
            application on the floor / bathtub.</p>
          <RadioField name="geriOtQuestionnaireQ15" label="geriOtQuestionnaire-Q15" />
          <br/>
          15. Is the toilet close by / adjunct to the bedroom?
          <p><b>Definition:</b> Less than 2 door distance away (including bathroom door)</p>
         ...
         <p><b>Definition:</b> Cupboards are accessible at shoulder and knee height - without the need
           to use chairs / stepladders to reach items</p>
          ...
          <p><b>Definition:</b> Meals can be carried safely, transported using trolley to wherever the
            client usually consumes meals</p>
          ...
          <p><b>Definition:</b> Grab bars must be easily gribbed, secure, robust throughout the steps /
            kerbs</p>
          ...
          <p><b>Definition:</b> Steps = more than 2 steps consecutively with a change in floor level
          Definition: Grab bars must be easily gripped, firmly fixed, robust and available for
            the full length of the steps or stairs</p>
          ...
          <p><b>Definition:</b> Steps are not too high, narrow, uneven for feet to be firmly placed.</p>
          <p><b>Definition:</b> Client will not be fatigued, breathless while using steps / kerbs or any
          other medical condition that will impair ability to ascend the stairs safely.
            Eg. Foot drop, loss of sensation in feet, impaired control of movement.</p>
          ...
          <p><b>Definition:</b> No patterned floor coverings, tiles, that could obscure the edge of step
            with sufficient lighting of the stairs / steps</p>
          ...
          <p><b>Definition:</b> Locks and bolts can be used without the need to bend down or over
          reach. There is a landing such that the client does not need to balance on steps to
            open the door.</p>
          ...
          over?
          <p><b>Definition: </b> “YES” when client does NOT need to bend down to feed pets, clean, refill
            bowls etc</p>
