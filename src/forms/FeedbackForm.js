      ...
      {loadingPrevData ? (
        ...
        <Fragment m={2} pt={2}>
          <div>
            ...
            {phlebotomy ? (phlebotomy.phlebotomyQ1 ? blueText('Yes') : blueText('No')) : '-'}
            <br></br>
            ...
            {underlined(
              "Participant's presenting complaints/ concerns requires scruitiny by doctor:",
            )}
            {hcsr ? blueText(hcsr.hxHcsrQ12) : '-'}
            <br></br>
            ...
            {dietitiansConsult
              ? dietitiansConsult.dietitiansConsultQ4
                ? blueText('Yes')
                : blueText('No')
              : '-'}
            <br></br>
            ...
            {oralHealth
              ? oralHealth.oralHealthQ1
                ? blueText(
                    'Yes. Kindly remind participants that NUS Dentistry will contact you regarding your future oral health appointments.',
                  )
                : blueText('No.')
              : '-'}
            <br></br>
