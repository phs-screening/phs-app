...
const schema = new SimpleSchema({
  ...
  geriOtQuestionnaireQ3: {
    ...
    custom: function () {
      if (
        this.field('geriOtQuestionnaireQ2').isSet &&
        this.field('geriOtQuestionnaireQ2').value === 'Yes (Specify in textbox )'
      ) {
    ...
    const newForm = () => (
      ...
      >
        <Fragment>
          ...
          <h4>If yes, refer occupational therapist consultation</h4>
          3. Do you use anything to support yourself (e.g. walking aid, umbrella) when moving about
          your daily activities?
          <RadioField name='geriOtQuestionnaireQ4' label='Geri - OT Questionnaire Q4' />
          <h4>If yes, refer occupational therapist consultation</h4>
          4. Do you frequently experience dizziness when standing up from a seated or laid down
          position?
          ...
          5. Do you experience urinary incontinence or nocturia (go toilet 3 or more times at
          night)?
          ...
          *Referral to Doctor’s Consult
          <RadioField
            ...
            checkboxes='true'
            label='Geri - OT Questionnaire Q8'
          />
          <h2>
