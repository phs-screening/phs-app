    ...
    const newForm = () => (
      ...
      >
        <Fragment>
          ...
          <h3>
            3.1.1. PHYSICAL ACTIVITY READINESS QUESTIONNAIRE (PAR-Q) <br />* If you have answered
            ‘Yes’ to one or more questions above, you should talk with your doctor BEFORE you start
          ...
          blood pressure or heart condition? <br />
          (If yes, refer to PT consult)
