        ...
        <Fragment>
          ...
          <h3>
            ...
            <span style={{ color: 'red' }}>
              <br />
              (Taken in NSS Questionnaire portion earlier on)
            </span>
          </h3>
          <h3>
            2. FINANCIAL STATUS
          ...
          <br />
          <span style={{ color: 'red' }}>Pull data from reg form</span>
          <br />
          ...
          <PopupText qnNo='hxSocialQ9' triggerValue='Yes'>
            ...
            <br />
            <br />
            3. Do you need assistance? (eg funds to hire a helper / funds to offset caretaking
            costs, subsidies for home healthcare items, arranging for short term care in nursing
            homes/senior care centres)
          ...
          <PopupText qnNo='hxSocialQ14' triggerValue='Yes'>
            <b>
              REFER TO NUS DENTISTRY ORAL SCREENING if participant has{' '}
              <mark>poor dental hygiene</mark> and <mark>interested</mark> to go through dental
              screening for participants aged <mark>40-59</mark>.{' '}
              <span style={{ color: 'red' }}>
                For participants 60 and above, functional screening includes oral screening.
              </span>
              <br />
