...
const schema = new SimpleSchema({
  ...
  geriGeriApptQ6: {
    type: String,
    allowedValues: ['Yes, requirement met.', 'No, requirement not met.'],
    optional: false,
  },
  geriGeriApptQ7: {
    type: String,
      ...
      >
        ...
        (typeof(info["Geri - Vision"]) !== "undefined" && info["Geri - Vision"].geriVisionQ4 >= 12)
          ...
          <span style={{ color: 'green' }}>
            THE BELOW APPEARS WHEN GERI VISION FORM MEETS CRITERIA (WIP)
          </span>
          <Fragment>
          ...
          <span style={{ color: 'green' }}>
            THE BELOW APPEARS WHEN GERI EBAS-DEP, PT CONSULT, OT CONSULT MEET CRITERIA (WIP)
          </span>
          {/*<DisplayIf condition={() => (
        ...
        (typeof(info["Geri - OT Consult"]) !== "undefined" && info["Geri - OT Consult"].geriOtConsultQ4 === "Yes")
          ...
          1) Participants will be eligible for the SWCDC Safe and Bright Homes Programme if they
          meet the following criteria:
          <br />
          i) SWCDC Resident (Link:{' '}
          <a href='https://sis.pa-apps.sg/NASApp/sim/AdvancedSearch.aspx'>
            https://sis.pa-apps.sg/NASApp/sim/AdvancedSearch.aspx
          </a>
          )<br />
          ii) Requires home modification (determined by SAOT) - Refer to Form A<br />
          <RadioField name='geriGeriApptQ6' label='Geri - Geri Appt Q6' />
          <PopupText qnNo='geriGeriApptQ6' triggerValue='Yes, requirement met.'>
            2) Do you wish to sign up for the SWCDC Safe and Bright Homes Programme?
            <br />
            <br />
            Persuade participant to sign up for SWCDC Safe and Bright Homes. <br />
            Description of the programme: “The Safe and Bright Homes programme aims to develop safer
            and more energy-efficient homes for senior citizens and persons with disabilities.
            Safety (e.g. bathroom grab bars, non-slip mats etc), energy and water conservation
            features (energy-saving bulbs, water thimbles and cistern bags etc) will be installed in
            selected homes of needy residents. Workshops will also be conducted to teach them how to
            troubleshoot common household problems. The programme will be spread out over 10
            sessions, for about 10 months.”
