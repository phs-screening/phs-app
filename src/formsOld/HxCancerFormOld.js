...
const schema = new SimpleSchema({
  ...
  'hxCancerQ25.$': {
    ...
    allowedValues: [
      ...
      'Doctors Consultation (& Dietitian) - As recommended by hx-taker, undiagnosed or non-compliant cases (HTN, DM, Vision Impairment, Hearing Impairment, Urinary Incontinence, Any other pertinent medical issues)',
      'Social Service - As recommended by hx-taker (CHAS Application, Financial Support required, Social Support required)',
      'Oral Health Screening - participants aged 40-59 with poor dental hygiene',
      ...
      >
        <Fragment>
          ...
          <b>
            ...
            Do be sensitive when asking for personal history of cancer. (please select all that
            apply)
          </b>
          <br />
          ...
          <font color='red'>
            <b>
              4. For <u>female</u> respondent aged 25 and above, who have/had a husband/boyfriend
              and not had their womb completely surgically removed only.
            </b>
          </font>
          <br />
          ...
          <b>
            <font color='red'>
              ...
              and above and if interested, refer to WCE.
              <br />
          ...
          2b. Please tick to highlight if you feel BMI or BP requires closer scrutiny by doctors and
          dietitians later.
